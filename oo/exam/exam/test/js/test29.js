    ...
    "exam": [
        {
            ...
            "values": [
                {
                    "type": 4,
                    "questionStem": "分别填一字井蛙不可以语于（     ）者，拘于虚也；夏虫不可以语于（     ）者，笃于时也；曲士不可以语于（     ）者，束于教也。——《庄子·秋水》 希望同学们背诵以上格言。【译文】井底的蛤蟆之所以不可以和它谈论大海，是因为它拘囿于自己狭小的天地里；夏季的虫子之所以不能和它谈论冰雪，因为它可怜的生存时间的限制。见识鄙薄的人之所以不能和他谈论大道，是因为他的格局器量局限了他的思维……生命是那样促狭、鄙陋又悲哀！",
                    "options": [
                        ""
                    ],
                    "answer": [
