    ...
    "exam": [
        {
            ...
            "values": [
                ...
                {
                    "type": 1,
                    "questionStem": "“不尚贤”是哪一家明确提出的主张_______",
                    "options": [
                        "墨家",
                        "道家",
                        "儒家",
                ...
                {
                    "type": 1,
                    "questionStem": "_____也者，天下之大本也；_____也者，天下之达道也。（《中庸》）",
                    "options": [
                        "礼、义",
                        "中、和",
                        "仁、爱",
                ...
                {
                    "type": 1,
                    "questionStem": "中华传统文化号为儒释道三家并存，释家文化作为外来文化传入中国的朝代是_______",
                    "options": [
                        "南朝（梁）",
                        "三国",
                        "唐代",
        ...
        // },
        {
            ...
            "values": [
                {
                    "type": 4,
                    "questionStem": "_________，水善利万物而不争。（《老子》第八章）",
                    "options": [
                        ""
                    ],
                    "answer": [
                ...
                {
                    "type": 4,
                    "questionStem": "道常________而无不为。《老子》（填写两字）",
                    "options": [
                        ""
                    ],
                    "answer": [
