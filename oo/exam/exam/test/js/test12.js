    ...
    "exam": [
        {
            ...
            "values": [
                {
                    "type": 4,
                    "questionStem": "真正有思想的作品与其他泛泛作品的区别之处，就在于前者具有一种断然和确切的特质与连带由此而来的______、明了。具备一流思想能力的人所带有的特质标记，就是他们所作出的判断都是直截了当、绝不含糊。每一个真正的独立、自为思考的思想家就这一方面而言跟_______相差无几。——叔本华《论思考》",
                    "options": [
                        ""
                    ],
                    "answer": [
