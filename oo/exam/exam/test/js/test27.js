    ...
    "exam": [
        {
            ...
            "values": [
                {
                    "type": 1,
                    "questionStem": "（    ）早在西汉时就被视为“六经之首”，其实是中华传统文化的第一元典。它讲究阴阳呼应、刚柔并济、周而复始，生生不息。其德义精神、人文内涵博大精深，其价值远远不是占卜算卦的神秘技艺，勃发着包罗宇宙、经纬人伦的深刻哲理。其代表的文化模式，深深影响了中华民族的科技文明、民族性格和中国人的思维方式和文化心理。中华书局其他版本亦可靠。另，推荐选本:",
                    "options": [
                        "《论语》",
                        "《道德经》",
                        "《周易》",
